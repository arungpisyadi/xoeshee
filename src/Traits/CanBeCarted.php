...
namespace Arungpisyadi\Xoeshee\Traits;
...
use Arungpisyadi\Xoeshee\Exceptions\ProductAttributesDoesNotMatchException;
...
trait CanBeCarted
{
	...
	{
		return $this->subtotal = app('CouponBaker')->appliedCoupons($coupons)->reduce(function ($carry, $coupon) {
