...
use Arungpisyadi\Xoeshee\Exceptions\CouponCanNotBePurchasedException;
use Arungpisyadi\Xoeshee\Exceptions\CouponExpiredException;
use Arungpisyadi\Xoeshee\Models\EloquentCoupon as Coupon;

class CouponBaker extends Baker {
	protected $model;
