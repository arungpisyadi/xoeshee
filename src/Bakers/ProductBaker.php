...
use Arungpisyadi\Xoeshee\Contracts\ProductInterface;
use Arungpisyadi\Xoeshee\Exceptions\PropertyIsNotEnabledExpcetion;
use Arungpisyadi\Xoeshee\Models\EloquentProduct;

class ProductBaker extends Baker implements ProductInterface {
	protected $model, $typeRepo, $variationRepo, $category, $baseQuery, $criteria = [];
	public function __construct(EloquentProduct $model) {
		$this->model = $model;
		$this->category = app('CategoryBaker');
